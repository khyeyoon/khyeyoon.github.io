...
<img src="/assets/img/FastText/eq2.JPG" width="40%" height="40%">
...
<img src="/assets/img/FastText/eq3.JPG" width="40%" height="40%">

  > 주변 단어에 대한 loss + negative sample에 대한 loss

  > Nt,c : vocabulary에서 샘플린된 negative examples의 집합
